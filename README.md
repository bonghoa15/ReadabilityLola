...
<code> <i>INSTALLATION</i> ```Pip install readabilitylola ```
...
================ <br />
Bahasa readability score formula: $$\-13.988 + 0.3793(300/S) + 0.0207(d+ k)$$ 
...
================ <br />
Hindi readability score formula: $$\-2.34+2.14AWL+0.01PSW $$ 
